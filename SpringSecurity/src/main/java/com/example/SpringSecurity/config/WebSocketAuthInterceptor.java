...
//                        );
//                        accessor.setUser(auth); // set user vào WebSocket session
//                    } else {
//                        throw new IllegalArgumentException("JWT token invalid");
//                    }
//                } catch (Exception e) {
//                    throw new IllegalArgumentException("JWT token invalid or expired", e);
//                }
//            } else {
